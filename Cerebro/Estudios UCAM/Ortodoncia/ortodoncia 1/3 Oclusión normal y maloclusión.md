...
>Es el tipo de oclusión más equilibrado para cumplir con la función masticatoria y preservar la integridad de la dentición a lo largo de la vida, en armonía con el conjunto estructural al que denominamos aparato estomatognático.

Hoy en día se admite que es perfectamente apropiado etiquetar de NORMAL una boca en la que todos los dientes están presentes y ocluyen de un modo saludable, estable y satisfactorio, aunque presenten variaciones en su posición dentro de ciertos límites ^[1: Bravo LA. Manual de ortodoncia de 2003]. 

## Las 6 claves para la oclusión normal:

### Eje mayor de la corona clínica
Es una línea que pasa por la porción más prominente del lóbulo central de cada cara vestibular con excepción de los molares, en los que sigue el surco que separa las cúspides vestibulares mayores.
...
Se define como **EM** al punto medio del eje mayor de la corona clínica. ^[2: Andrews LF et al. The six keys to normal occlusion 1972]. ^c0ca44

![[Pasted image 20231115165834.png]]

### Plano de Andrews:
Es un plano que divide las coronas de los dientes en oclusión normal a la altura de sus puntos [[#^c0ca44|EM]], o en el caso de un diente aislado, separa la porción oclusal de la gingival a la altura de [[#^c0ca44|EM]].

### Oclusión normal según Angle 1890
1. Las cúspides mesiovestibular de los 1 molares superiores coincidía A-P con el surco vestibular principal de los 1 molares inferiores.
2. Los dientes disponían siguiendo una suave línea de oclusión, de forma más o menos parabólica, única y diferente para cada individuo, que "sería aquella respecto a la cual cada diente debería estar en perfecta armonía si es que estaba en oclusión normal."
![[Pasted image 20231115170753.png]]


En el trabajo titulado "Seis llaves para la oclusión normal", Andrews describe los seis factores que consideró comunes a 120 oclusiones normales no tratadas ortodóncicamente. Eran modelos pertenecientes a pacientes con oclusiones "_perfectas_" desde el punto de vista anatómico y funcional que no podían ser mejoradas con terapia ortodóncica.

### Clave 1 Relación Molar
La clase I molar es cuando:
1. La cúspide mesio vestibular del primer molas superior ocluye en el surco entre las cúspides vestibulares mesial y media del primer molar inferior _definición [[Clase I]] de Angle._
	![[Pasted image 20231115220438.png]]

2. La cúspide mesiopalatina del primer molar superior asienta en la fosa central del primer molar inferior.
	![[Pasted image 20231115220538.png]]
...
5. El canino superior tienen una relación cúspide-tronera con el canino inferior y el 1 premolar inferior. La punta de su cúspide está ligeramente mesial a la tronera.

### Clave 2 Angulación mesiodistal de las coronas (TIP)
La porción gingival del eje de la corona debe estar ubicada en una posición más distal que la porción oclusal. (_Angulación +_)

La inclinación de las coronas se mide entre el eje mayor de la corona clínica y una perpendicular al [[#Plano de Andrews]].
![[Pasted image 20231115223451.png]]

Básicamente todas las coronas en oclusión óptima presentan una angulación positiva, salvo en el caso de los premolares de ambas arcadas y de los incisivos inferiores y molares inferiores, en los que la angulación de sus coronas es prácticamente nula.

![[Pasted image 20231115223650.png]]

La inclinación coronaria adecuada requiere mayor espacio mesiodistal.

![[Pasted image 20231115223740.png]]

### Clave 3 Inclinación labiolingual de las coronas (_torque_)
El torque coronario está medido en grados entre una perpendicular al [[#Plano de Andrews]] que pasa por el punto [[#^c0ca44|EM]] y una tangente a la cara vestibular del diente que, pasando por el mismo punto, tiene sus extremos a igual distancia de la porción incisal y gingival de la corona.
![[Pasted image 20231115224252.png]]

La tangente que pasa por el punto [[#^c0ca44|EM]] de los incisivos superiores tiene una inclinación desde gingival y palatino hacia incisal y vestibular (_torque positivo_).

En los restantes dientes del Maxilar superior y todos los del inferior, la tangente va desde vestibular y gingival hacia oclusal y lingual (_torque negativo_).

![[Pasted image 20231115225009.png]]

A medida que se avanza hacia distal, aumenta el valor del torque negativo

![[Pasted image 20231115225108.png]]

> [!warning] Angulo interincisivo es menor a 180º
> ![[Pasted image 20231115225204.png]]

El torque coronario también puede evaluarse teniendo en cuenta el eje mayor del diente. Para un mismo diente se observan valores diferentes según cómo se realice la medición.
![[Pasted image 20231115225933.png]]
> Al analizar los valores de preajuste que presenta una determinada aparatología se debe tener en cuenta a qué tipo de medición se refieren los valores dados para el torque.

#### Influencia del torque en la relación interoclusal:
![[Pasted image 20231115230046.png]]

Un correcto torque del sector anterior resulta indispensable para obtener la relación canina y molar de [[Clase I]]

> [!danger] 👀
> A. Torque Normal
> B. Ante una falta de torque el sector anterior se pueden producir diastemas.
> C. La falta de torque sin diastemas origina una relación de [[Clase II]].
...
Las rotaciones en el sector anterior afectan notoriamente a la estética.

Las rotaciones en el sector posterior son más importantes los trastornos funcionales que ocasionan. Por ejemplo una pieza posterior rotada varía la ubicación de sus cúspides y altera la relación interoclusal, es decir, la clase canina y la relación molar, o el overjet y overbite.

![[Pasted image 20231115230929.png]]

La correlación de la frecuente rotación de los primeros molares superiores es particularmente importante para el establecimiento de una oclusión correcta.
![[Pasted image 20231115231111.png]]
...
![[Pasted image 20231115231629.png]]

### Clave 6 Curva de Spee
Variará desde una superficie PLANA hasta una ligera concavidad. En la mandíbula no debe tener una profundidad mayor de 1,5 mm.

Una curva de Spee **profunda** provoca alteraciones en el plano oclusal impidiendo una correcta intercuspidación, generando una oclusión traumática.
