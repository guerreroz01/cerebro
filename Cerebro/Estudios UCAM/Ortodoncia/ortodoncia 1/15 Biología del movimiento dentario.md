...
En los tratamientos de ortodoncia nos basamos del principio de que, ante la presión mantenida sobre un diente de manera prolongada en el tiempo, éste se moverá gracias a que el hueso que lo rodea sufre procesos de remodelado, existiendo zonas de reabsorción y zonas de aposición. Dicho diente se desplazará a través del hueso llevando consigo su aparato de inserción.

La respuesta biológica a las fuerzas ortodóncicas también pueden influir en zonas de crecimiento ajenas al ligamento periodontal, como la sutura media del maxilar superior o la articulación temporomandibular.

## Respuesta ósea y periodontal a la función normal
### Estructura y función del ligamento periodontal.
Cada diente se encuentra unido a su alveolo y separado del mismo mediante una estructura de soporte, <span style="color:#ff0000">el ligamento periodontal (LP). Esta estructura tiene una anchura de 0,5 mm en condiciones normales</span>.

El componente principal del ligamento periodontal es el entramado de fibras de colágeno que se insertan por un lado en el cemento radicular y por otro en la lámina dura. Estas fibras se disponen con una angulación determinada para permitir el desplazamiento del diente durante la función normal, insertándose más apical en el diente que sobre el hueso alveolar.

Además de las fibras de colágeno, en el LP encontramos:
- Elementos celulares
- Elementos vasculares y neurales
- Fluido tisular
![[Pasted image 20240124092004.png]]
...
En el LP encontramos vasos sanguíneos y células del sistema vascular. También encontramos terminaciones nerviosas, tanto amielínicas, asociadas con la percepción del dolor, como receptores más complejos asociados a la presión y e información posicional (propiocepción).

El fluido tisular que se localiza en el LP deriva del sistema vascular y tiene la función de amortiguar y disipar las presiones de la función masticatoria normal.

### Respuesta a la función normal
Durante la función masticatoria normal, el periodonto es sometido a <span style="color:#f519e3">fuerzas intensas e intermitentes que duran menos de un segundo y que pueden tener una magnitud (fuerza "F") de entre 1 y 50 kg</span>

![[Pasted image 20240124092956.png]]

Al someter a un diente a una presión intensa, el líquido del LP actúa como un amortiguador evitando un rápido desplazamiento del diente dentro del espacio periodontal. Esta fuerza será transmitida al hueso alveolar el cual se deformará en respuesta a dicha fuerza.

Esta deformación ósea durante la función normal genera corrientes piezoeléctricas, las cuales parecen ser un estímulo importante para regeneración y reparación esquelética. Supondría un mecanismo de adaptación de la arquitectura ósea a las demandas funcionales.

En la tabla se muestra como tras la aplicación de una fuerza intensa durante 3 - 5 segundos, sale el líquido del LP apareciendo el dolor, como señal de que el LP está recibiendo la presión directamente.

Aunque el LP está perfectamente adaptado para resistir fuerzas de escasa duración, pierde rápidamente su capacidad de adaptación al salir el líquido hísitco de su área.

### Respuesta fisiológica de una presión sobre un diente

| Tiempo (segundos) | Respuesta |
| ---- | ---- |
| < 1 | El líquido del LP no se comprime, el hueso alveolar se flexiona, se genera una señal piezoeléctrica |
| 1 - 2 | Se exprime el líquido del LP, el diente se mueve dentro del espacio del LP |
| 3 - 5 | Sale el líquido del LP, los tejidos se comprimen; dolor inmediato si la presión es intensa.<br> |

### Papel del ligamento periodontal en la erupción y estabilización dental
Durante el proceso de erupción dental, se dan una serie de procesos metabólicos en el LP, incluyendo la formación, el establecimiento de enlaces cruzados y el acortamiento tras la maduración de las fibras de colágeno.

Este proceso continúa durante la vida adulta, aunque en menor medida. Este mecanismo permite una estabilización activa de los dientes frente a fuerzas prolongadas de ligera magnitud, evitando que los dientes se muevan.
...
- <span style="color:#ffff00">La teoría bioeléctrica</span>: El movimiento dental se producirá por señales eléctricas que se generan cuando el hueso alveolar se ve flexionado y deformado.
- <span style="color:#ffff00"> La teoría de la presión-tensión</span>: Se producirá una alteración en el flujo sanguíneo que daría lugar a unos cambios celulares mediados por mensajeros químicos.

Ambas teorías no son incompatibles, y actualmente se acepta que las dos pueden intervenir en el control biológico del movimiento dentario.

#### La teoría bioeléctrica
Se explica mediante el fenómeno de la piezoelectricidad. Este proceso ocurre en muchas sustancias cristalinas por el que la deformación de esta estructura cristalina provoca un flujo de corriente eléctrica al desplazar los electrones de una parte de la retícula cristalina a otra.

La piezoelectricidad se da también en muchos cristales orgánicos, pudiendo darse en la estructura cristalina del mineral óseo y también en el colágeno.

Un aspecto importante de las señales piezoeléctricas es que tienen dos características principales:
- Rápida desaparición, cuando se aplica una fuerza se crea una señal que baja rápidamente a cero, aunque la fuerza se mantenga
- Producción de una señal equivalente, de dirección opuesta cuando la fuerza deja de actuar.
![[Pasted image 20240124104254.png]]

Hoy en día se sabe que las señales piezoeléctricas generadas en las estructuras óseas durante la función normal son fundamentales para el mantenimiento del mineral óseo, evitando así una atrofia esquelética. A nivel dental estas señales durante la función masticatoria normal serían de gran importancia para mantener el hueso alveolar de los dientes.

No obstante, como las fuerzas que se utilizan para el movimiento ortodóncico son fuerzas mantenidas, donde las señales piezoeléctricas perderían protagonismo, se le dan menos importancia en el control de movimiento ortodóncico que en el mantenimiento de la función esquelética normal.

#### La teoría de la presión-tensión (flujo sanguíneo)
Postula que la presión mantenida sobre un diente obliga al diente a cambiar de posición en el LP, comprimiendo el ligamento en unos puntos y tensándolo en otros. Esto provocaría una alteración en el flujo sanguíneo, disminuyendo donde el LP queda comprimido y aumentando en los puntos de tensión. Evidentemente, el O$_{2}$ aumentará en el lado de tensión y disminuirá en el lado de presión, por el contrario el CO$_{2}$ disminuirá en el lado de tensión y aumentará en el lado de presión. Estos cambios en el entorno químico desencadenarán la liberación de sustancias biológicamente activas, las cuales estimularán los cambios celulares, diferenciación y activación.
![[Pasted image 20240124105137.png]]

### Efecto de la magnitud de las fuerzas
A medida que la magnitud de la fuerza mantenida se va incrementando, mayor será la reducción del flujo sanguíneo a través de las zonas comprimidas del LP
![[Pasted image 20240124105318.png]]
...
#### Ante una fuerza intensa, pero prolongada
- Oclusión total de los vasos sanguíneos.
- Necrosis aséptica en la zona comprimida, dando un área avascular denominada <span style="color:#ff0000">"hializinada"</span>.
- Al cabo de varios días aparecen los osteoclastos procedentes de zonas periféricas y comienzan a reabsorber la zona necrosada. Este proceso recibe el nombre de <span style="color:#ff0000">"reabsorción basal secundaria"</span>.
- Por tanto, existe un retraso en el movimiento dental por un retraso en el estímulo y por tener que eliminar un mayor grosor óseo. Además, el dolor es mayor cuando existe esta reabsorción secundaria.

La suave progresión del movimiento dental que se produce con una fuerza suave y constante en muchas ocasiones puede resultar una utopía, pues en la práctica clínica diaria el movimiento dental se suele producir de manera más escalonada, debido a la inevitable formación de zonas de reabsorción basal. No obstante, las fuerzas excesivas no tienen ninguna utilidad.

![[Pasted image 20240124110638.png]]

### Respuesta fisiológica a la aplicación de una presión mantenida sobre un diente

| Tiempo |  | Respuesta |
| ---- | ---- | ---- |
| Presión leve | presión intensa |  |
| <1 segundo | <1 segundo | Líquido LP no se comprime, flexión hueso alveolar, señal piezoeléctrica |
| 1 -2 segundos | 1 - 2 segundos | Se exprime el líquido LP, diente se mueve en el espacio periodontal |
| 3 -5 segundos |  | Vasos sanguíneos LP parcialmente comprimidos en el lado de presión, dilatación en el lado tensión; distorsión mecánica de las fibras y células del LP |
...
| Aproximadamente 4 horas |  | Aumentan los niveles de AMPc, comienza la diferenciación celular en LP |
| Aproximadamente 2 días |  | Comienza el movimiento dental al remodelar los osteoblastos/osteoclastos el alveolo óseo |
|  | 3 5 segundos | Los vasos sanguíneos del LP quedan ocluidos en el lado de presión |
|  | Minutos | Se interrumpe el flujo sanguíneo en la zona comprimida del LP |
|  | Horas | Muerte celular en el área comprimida |
|  | 3 - 5 días | Diferenciación celular en zonas adyacentes, comienza la reabsorción secundaria |
|  | 7 - 14 días | La reabsorción basal o secundaria elimina la lámina dura adyacente al LP comprimido, se produce el movimiento del diente. |


## Efectos biológicos según el movimiento dental
La forma más sencilla de movimiento ortodóncico es la <span style="color:#ff0000">inclinación</span>. Estos movimientos se consiguen cuando una fuerza única se aplica contra la corona del diente (como por ejemplo el resorte de una placa).

Al inclinar un diente, sólo actuamos sobre la mitad de la superficie del LP, por lo que la presión que se genera en las dos zonas afectadas (en el reborde alveolar y en el ápice) es muy elevada en comparación a la fuerza que se aplica. Por este motivo las fuerzas necesarias para inducir movimientos de inclinación deben de ser de baja magnitud, no superando los 60 gr de fuerza.

![[Pasted image 20240124120007.png]]

Por otro lado, para inducir un movimiento en <span style="color:#ff0000">masa</span> del diente, es necesario que la fuerza actúa uniformemente en toda la superficie del LP, desde el borde alveolar hasta el ápice. Por ello, al tener que abarcar una mayor área del LP, para un movimiento en masa se necesita aproximadamente el doble de fuerza que para inducir su inclinación, estando en torno a los 70 - 120 gr de fuerza.

![[Pasted image 20240124120242.png]]

Para los movimientos de <span style="color:#ff0000">rotación</span> podríamos pensar que las fuerzas necesarias deberían ser mucho mayores, puesto que estas fuerzas deberían distribuir por todo el LP. Sin embargo, es muy difícil inducir un movimiento de rotación sin inclinar también el diente en ele alveolo en parte, por lo que las fuerzas necesarias para los movimientos de rotación son parecidas a las que se necesitan para la inclinación.

Para los movimientos de <span style="color:#ff0000">extrusión</span>, hay que tener en cuenta que es posible también generar movimientos de inclinación simultáneamente por lo que las fuerzas necesarias también son parecidas a las necesarias para la inclinación. Además, hay que tener en cuenta que, al aplicar una fuerza extrusiva, lo que se pretende es arrastrar el hueso alveolar junto con el diente por lo que la fuerza no debe ser excesiva.

Al igual que sucede con la extrusión, el diente también se inclina durante la <span style="color:#ff0000">intrusión</span>. No obstante, una gran cantidad de fuerza se concentra en la región apical, por lo que si pretendemos provocar una intrusión dental verdadera deberíamos aplicar fuerzas de poca intensidad, en torno a 10 - 20 gr.
![[Pasted image 20240124120932.png]]
...
A nivel clínico, en relación a la experiencia con los seres humanos, se ha visto que existe un umbral de duración de la fuerza para inducir el movimiento ortodóncico que se localiza en torno a las 6 horas. Además, si las fuerzas se mantienen durante más tiempo (más de 6 horas), se consigue una movilización dental cada vez más eficaz.
![[Pasted image 20240124132711.png]]
...
![[Pasted image 20240124133414.png]]

Las fuerzas generadas durante la función normal pueden considerarse un caso especial de fuerzas intermitentes, pero la mayor parte de ellas no son mantenidas las horas suficientes durante el día como para provocar efectos significativos en la posición de los dientes.

Vamos a considerar dos supuestos en relación a la duración de las fuerzas:
1. <span style="color:#ff0000">Fuerzas contínua ligera</span>: El nivel de fuerza ligera permite una progresión relativamente suave del movimiento dentario debido a una reabsorción directa o frontal
2. <span style="color:#ff0000">Fuerza contínua intensa</span>: El movimiento dentario se retrasará hasta que la reabsorción secundaria puede eliminar el hueso necesario, el diente cambiará de posición con rapidez y la fuerza constante comprimirá de nuevo los tejidos evitando la reparación del LP. Esto creará la necesidad de una nueva reabsorción secundaria. Este tipo de fuerza es muy destructiva para el diente y el periodonto.
3. <span style="color:#ffff00">Fuerza interrumpida ligera</span>: El diente se moverá una corta distancia mediante reabsorción directa permaneciendo en esa posición hasta que el aparato sea activado de nuevo.
4. <span style="color:#ffff00">Fuerza interrumpida intensa</span>: El diente se moverá mediante reabsorción secundaria y permanecerá en esa posición hasta la próxima activación. Esto dejará tiempo para la regeneración del LP hasta la nueva activación.
...
## Fármacos y su interacción con el movimiento ortodóncico
Actualmente se sigue trabajando en la posibilidad de administrar algún fármaco que acelere el movimiento dental durante los tratamientos de ortodoncia, pero a día de hoy no sabemos cuanto tiempo tardarán en aplicarse.

Se ha comprobado que la inyección directa de prostaglandina en el LP acelera el movimiento dental pero es bastante dolorosa y no resulta útil a nivel práctico.

Lo que si sabemos es que existen fármacos que se prescriben para otras utilidades y que tienen un efecto inhibidor del movimiento dentario. Los grupos principales son:
1. Inhibidores de las prostaglandinas, como la intometacina, utilizados para control del dolor (ejemplo artritis).
2. Bifosfonatos, utilizados para el tratamiento de la osteoporosis.

### Inhibidores de las prostaglandinas
Los fármacos que modifican la actividad de las prostaglandinas los podemos clasificar en 2 categorías
- Corticoesteroides y antiinflamatorios no esteroideos (AINEs)
- Otros agentes con actividad agonista y antagonista sobre diferentes prostaglandinas

![[Pasted image 20240124185028.png]]

Los corticosteroides reducen la síntesis de prostaglandinas inhibiendo la formación de ácido araquidónico; los AINE inhiben la conversión del ácido araquidónico en prostaglandinas.

Esto plantea la posibilidad de que la medicación utilizada por los pacientes para controlar el dolor dental (ácido acetilsalicílico, ibuprofeno, naproxeno y muchos otros) después de la consiguiente activación podría interferir negativamente en la tasa de movimiento dental esperado.

La excepción la encontraríamos con el uso del paracetamol, que se ha visto como la mejor alternativa para el control del dolor dental durante los tratamientos ortodóncicos, debido a su actividad periférica y escasa interacción con el freno del movimiento dental.

Otros fármacos que se han relacionado con respuestas inusuales a las fuerzas ortodóncicas, ya sea por la alteración en la síntesis de las prostaglandinas o un defecto en el reclutamiento de los osteoclastos:
- Antidepresivos tricíclicos: doxepina, amitriptilina, imipramina.
- Antiarrítmicos: procaína.
- Antipalúdicos: quinina, quinidina y cloroquina.
- Anticonvulsionantes: difenilhidantoina

### Bifosfonatos
Los bifosfonatos inhiben la reabsorción ósea mediada por los osteoclastos por lo del remodelado óseo en estos pacientes se verá deprimido. Este tipo de tratamiento se aplica generalmente en mujeres postmenopáusicas para evitar la pérdida ósea. El uso de estos fármacos plantea un problema por dos motivos principales:
- Riesgo de osteonecrosis mandibular tras exodoncia dental por motivo ortodóncico.
- Permanencia prolongada en el hueso a pesar de suprimir la medicación.
